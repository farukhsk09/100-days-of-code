    ...
    return (
        <div className='sidebar'>
            <div className="heading">
                ...
                <h1><FaSolidGraduationCap className='icon'></FaSolidGraduationCap>scholaris</h1>
            </div>
            <div className='menu'>
